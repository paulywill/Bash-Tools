...
I thought I'd dump a few bash tools, sample data, and some Nano syntax highlighting for the fediverse to enjoy.
...
`nano/` : some .nanorc I love, including @IBPX's `fountain.nanorc`
...
`tools/` : dirty 🤖 helped me make some buggy and shaddy script to make data entry and reporting/graphing easier in ASCii
